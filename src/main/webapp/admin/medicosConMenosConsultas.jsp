<%-- 
    Document   : medcosConMenosConsultas
    Created on : 6/10/2020, 11:40:01
    Author     : asael
--%>
    ...
    <body>
        ...
        <div class="container-fluid mt-5 pl-4">
            <div class="row">
                <div class="col-xl-10">
                    <div class="mb-4">
                        <h4>Los 5 medicos con menos consultas</h4>
                    </div>
                    <form class="form-inline ml-3" action="${pageContext.request.contextPath}/ReportesAdminServlet?accion=reporte3" method="POST"> 
            ...
            <div class="row pt-4">
                <div class="col-xl-8">
                    ...
                    <!-- 5 medicos con menos consultas en un intervalo de tiempo -->
                    <c:choose>
                        <c:when test="${!empty(medicosConsultas)}">
                            <div class="card">
                                <div class="card-body">
                                    <table class="table table-striped">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th>nombre</th>
                                                <th>No. Colegiado</th>
                                                <th>Cant. Consultas</th>
                                            </tr>
                                        </thead>
                                        <tbody>

                                            <c:forEach var="medico" items="${medicosConsultas}">
                                                <tr>
                                                    <td>${medico.codigo}</td>
                                                    <td>${medico.nombre}</td>
                                                    <td>${medico.noColegiado}</td>
                                                    <td>${medico.consultas}</td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>	
                        ...
                        <c:otherwise>
                            <c:if test="${buscado}">
                                <h4>No hay consultas en el intervalo de fechas dado</h4>
                            </c:if>
                        </c:otherwise>
                    </c:choose>
                </div>
